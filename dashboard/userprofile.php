...
<div class="container p-4 mt-5">
    <h1 class="text-center">Welcome to your Profile
...
<div class="container">
	<div class="row">
		<div class="col-md-6 col-8 offset-2 offset-md-3 text-center p-3  bg-dark mb-2 rounded">
			<form role="form" action="" method="POST" enctype="multipart/form-data" class="mb-2">
				<div class="form-group">
						<img class="img-fluid" style="border-radius: 5%;" height="150" width="150" src="profilepics/<?php echo $picture; ?>" alt="Photo">
						<br>
						<p class="text-white">Your profile picture</p>
                ...
                <button type="submit" name="uploadphoto" class="btn btn-success btn-block" value="upload photo">upload photo</button>
			</form>
		</div>
	</div>
</div>
...
<div class="container mb-4">
	 <form role="form" class="bg-dark p-4 rounded" action="" method="POST" enctype="multipart/form-data">
        <p class="text-center text-white">Update your information</p>
        <hr>
		<div class="form-group">
			<label for="user_title" class="text-white">User Name</label>
			<input type="text" name="username" class="form-control" value=" <?php echo $username; ?>" readonly>
		</div>

		<div class="form-group">
			<label for="user_author" class="text-white">Name</label>
			<input type="text" name="name" class="form-control"  value="<?php echo $name; ?>" required>
		</div>

		<div class="form-group">
			<label for="user_tag" class="text-white">Email</label>
			<input type="email" name="email" class="form-control"  value="<?php echo $useremail; ?>" required>
		</div>
		
		<div class="form-group">
			<label for="post_content" class="text-white">Bio</label>
			<textarea  class="form-control" name="bio" id="" cols="30" rows="10"><?php  echo $bio;  ?>
			</textarea>
		</div>

		<div class="form-group">
			<label for="usertag" class="text-white">Current Password</label>
			<input type="password" name="currentpassword" class="form-control" placeholder="Enter Current password" required>
		</div>
		<div class="form-group">
			<label for="usertag" class="text-white">New Password <font color='brown'> (changing password is optional)</font></label>
			<input type="password" name="newpassword" class="form-control" placeholder="Enter New Password">
		</div>
		<div class="form-group">
			<label for="usertag" class="text-white">Confirm New Password</label>
